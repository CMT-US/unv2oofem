...
namespace oofem {
REGISTER_BoundaryCondition(PrescribedFieldsGradientDirichlet);

double PrescribedFieldsGradientDirichlet :: give(Dof *dof, ValueModeType mode, double time)
{
...
void PrescribedFieldsGradientDirichlet :: updateCoefficientMatrix(FloatMatrix &C)
...
void PrescribedFieldsGradientDirichlet :: computeStress(FloatArray &sigma, TimeStep *tStep)
{
...
void PrescribedFieldsGradientDirichlet :: computeTangent(FloatMatrix &tangent, TimeStep *tStep)
{
// a = [a_c; a_f];
// K.a = [R_c,0];
...
IRResultType PrescribedFieldsGradientDirichlet :: initializeFrom(InputRecord *ir)
{
...
void PrescribedFieldsGradientDirichlet :: giveInputRecord(DynamicInputRecord &input)
{
