...
public:
    ...
    const char *giveClassName() const override { return "PrescribedGradientDD"; }
    const char *giveInputRecordName() const override { return _IFT_PrescribedGradientDD_Name; }
