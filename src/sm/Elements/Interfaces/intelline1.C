...
Interface *
IntElLine1 :: giveInterface(InterfaceType interface)
{
...
void
IntElLine1 :: NodalAveragingRecoveryMI_computeNodalValue(FloatArray &answer, int node,
                                                              InternalStateType type, TimeStep *tStep)
{
    ...
    answer.resize(3); //How to make it more generic? It should read the IST_type and decide the size on its own
