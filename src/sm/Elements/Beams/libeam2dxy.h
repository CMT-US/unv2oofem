...
#define _IFT_LIBeam2dxy_Name "libeam2dxy"
 ...
 */
class LIBeam2dxy : public StructuralElement, public LayeredCrossSectionInterface
{
protected:
    /// Interpolation
...
public:
    ...
    LIBeam2dxy(int n, Domain * aDomain);
    virtual ~LIBeam2dxy() { }
    ...
    const char *giveInputRecordName() const override { return _IFT_LIBeam2dxy_Name; }
